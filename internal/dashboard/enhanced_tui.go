...
func NewCommandPalette() *CommandPalette {
	cmds := []CommandItem{
	{ID: "new_file", Name: "New File", Description: "Create a new file", Category: "File", Shortcut: "⌘N", Action: nil},
	{ID: "open_file", Name: "Open File", Description: "Open an existing file", Category: "File", Shortcut: "⌘O", Action: nil},
	{ID: "save", Name: "Save", Description: "Save current file", Category: "File", Shortcut: "⌘S", Action: nil},
	{ID: "find", Name: "Find in Files", Description: "Search across codebase", Category: "Edit", Shortcut: "⌘F", Action: nil},
	{ID: "replace", Name: "Find & Replace", Description: "Find and replace text", Category: "Edit", Shortcut: "⌘H", Action: nil},
	{ID: "format", Name: "Format Code", Description: "Auto-format the code", Category: "Edit", Shortcut: "⇧⌘F", Action: nil},
	{ID: "comment", Name: "Toggle Comment", Description: "Comment/uncomment lines", Category: "Edit", Shortcut: "⌘/", Action: nil},
		
	{ID: "git_status", Name: "Git Status", Description: "Show git status", Category: "Git", Shortcut: "⌘G", Action: nil},
	{ID: "git_commit", Name: "Git Commit", Description: "Commit changes", Category: "Git", Shortcut: "⌘⏎", Action: nil},
	{ID: "git_push", Name: "Git Push", Description: "Push to remote", Category: "Git", Shortcut: "", Action: nil},
	{ID: "git_pull", Name: "Git Pull", Description: "Pull from remote", Category: "Git", Shortcut: "", Action: nil},
	{ID: "git_diff", Name: "Git Diff", Description: "Show changes", Category: "Git", Shortcut: "⌘D", Action: nil},
	{ID: "git_branch", Name: "Git Branch", Description: "Manage branches", Category: "Git", Shortcut: "", Action: nil},
		
	{ID: "run_test", Name: "Run Tests", Description: "Execute test suite", Category: "Run", Shortcut: "⌘T", Action: nil},
	{ID: "run_build", Name: "Build", Description: "Build the project", Category: "Run", Shortcut: "⌘B", Action: nil},
	{ID: "run_debug", Name: "Debug", Description: "Start debugging", Category: "Run", Shortcut: "⌘⌥D", Action: nil},
	{ID: "stop", Name: "Stop", Description: "Stop current operation", Category: "Run", Shortcut: "⌘.", Action: nil},
		
	{ID: "model_list", Name: "List Models", Description: "Show available AI models", Category: "AI", Shortcut: "/list", Action: nil},
	{ID: "model_switch", Name: "Switch Model", Description: "Change active model", Category: "AI", Shortcut: "/model", Action: nil},
	{ID: "model_info", Name: "Model Info", Description: "Show current model details", Category: "AI", Shortcut: "/stats", Action: nil},
		
	{ID: "settings", Name: "Settings", Description: "Open settings", Category: "View", Shortcut: "⌘,", Action: nil},
	{ID: "toggle_terminal", Name: "Toggle Terminal", Description: "Show/hide terminal", Category: "View", Shortcut: "⌘`", Action: nil},
	{ID: "toggle_sidebar", Name: "Toggle Sidebar", Description: "Show/hide file tree", Category: "View", Shortcut: "⌘B", Action: nil},
	{ID: "split_view", Name: "Split View", Description: "Toggle split view", Category: "View", Shortcut: "⌘\\", Action: nil},
		
	{ID: "help", Name: "Help", Description: "Show help and shortcuts", Category: "Help", Shortcut: "F1", Action: nil},
	{ID: "about", Name: "About", Description: "Show about info", Category: "Help", Shortcut: "", Action: nil},
	{ID: "check_updates", Name: "Check Updates", Description: "Check for updates", Category: "Help", Shortcut: "", Action: nil},
	}
